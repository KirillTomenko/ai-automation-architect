...
Фронтенд: **http://localhost:8000/** — форма ввода и выпадающий список из 7 готовых кейсов разных типов бизнеса — Telegram-заявки, запись на услуги, e-commerce, HR-онбординг, логистика, претензия на возврат и обезличенный вариант коммуникационного процесса (рендерятся без вызова LLM). «Построить Blueprint» — живой прогон через 4 стадии, обычно 20–60 секунд. Программный доступ: `POST /blueprint` с телом `{"description": "..."}`.
