...
Четыре готовых кейса разных типов бизнеса — Telegram-заявки, запись на услуги, обработка заказов e-commerce и обезличенный вариант коммуникационного процесса — доступны без вызова LLM в выпадающем списке фронтенда (`examples/blueprints/`).
